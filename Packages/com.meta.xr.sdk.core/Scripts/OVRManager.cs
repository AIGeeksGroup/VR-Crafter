...
{
    // Project compatibility patch: allow applications that do not use deprecated
    // buffered haptics to stop its per-frame descriptor query on PC OpenXR.
    [Tooltip("Process deprecated OVRHaptics buffers. Disable when the application does not use legacy buffered haptics.")]
    public bool enableLegacyHaptics = true;
    public enum XrApi
    {
...
#pragma warning disable CS0618
        if (enableLegacyHaptics) OVRHaptics.Process();
#pragma warning restore CS0618
